// Fixed formQuestions.ts with all questions in correct order
...
export const paper2Questions: FormQuestion[] = [
  ...
  },
  {
    id: 'heart_attack',
    type: 'yes-no',
    question: '13. Have you ever had a heart attack?',
    section: 'Cardiovascular Conditions'
  },
  {
    id: 'angina',
  ...
  },
  {
    id: 'colitis',
    type: 'yes-no',
    question: '42. Do you have colitis?',
    section: 'Digestive System'
  },
  ...
  // Substance Use (Questions 43-45)
  {
    id: 'tobacco_use',
    type: 'yes-no-details',
    question: '43. Do you use tobacco products (cigarettes, cigars, chewing tobacco, etc.)?',
    section: 'Substance Use',
    detailsPlaceholder: 'Please specify type and frequency'
  },
  {
    id: 'alcohol_use',
    type: 'yes-no-details',
  ...
  },
  {
    ...
    type: 'yes-no-details',
    question: '45. Do you use recreational drugs?',
    section: 'Substance Use',
    detailsPlaceholder: 'Please specify (confidential)'
  },
  ...
  },
  {
    id: 'osteoporosis',
    type: 'yes-no',
    question: '54. Do you have osteoporosis?',
    section: 'Other Medical Conditions'
  },
